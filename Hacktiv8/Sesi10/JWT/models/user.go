...
type User struct {
	GormModel
	Username     string        `gorm:"not null;Index" json:"full_name" form:"username" valid:"required-Your full name is required"`
	Email        string        `gorm:"not null;Index" json:"email" form:"email" valid:"required-Your email is required,email-Invalid email format"`
